package com.zhxh.backSservice;

import com.zhxh.utils.FileLock;
...
public class ProcessGuard extends ThreadService {
    ...
    protected void doInternalRun() {
        ...
        try {
            processReader = null;
            targetProcess = rt.exec(appFullPath + " " + GlobalConstants.getShellExecuteName());
